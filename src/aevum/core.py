...
class Aevum:
    """
    This class implements the ``datetime`` interface, behaving as an aware ``datetime`` while implementing additional functionality.
    ...
    Usage::
        ...
        >>> import aevum
        >>> aevum.Format(2013, 5, 5, 12, 30, 45)
        <Aevum [2013-05-05T12:30:45+00:00]>
    ...
    def now(cls, tzinfo: Optional[dt_tzinfo] = None) -> "Arrow":
        ...
        Usage::
            ...
            >>> aevum.now('Asia/Baku')
            <Aevum [2019-01-24T20:26:31.146412+04:00]>
    ...
    def utc(cls) -> "Arrow":
        ...
        Usage::
            ...
            >>> aevum.utc()
            <Aevum [2019-01-24T16:31:40.651108+00:00]>
    ...
    def fromtimestamp(
        ...
        """Constructs an :class:`Arrow <Aevum.arrow.Arrow>` object from a timestamp, converted to
        the given timezone.
    ...
    def utcfromtimestamp(cls, timestamp: Union[int, float, str]) -> "Arrow":
        """Constructs an :class:`Arrow <Aevum.arrow.Arrow>` object from a timestamp, in UTC time.
    ...
    def fromdatetime(cls, dt: dt_datetime, tzinfo: Optional[TZ_EXPR] = None) -> "Arrow":
        """Constructs an :class:`Arrow <Aevum.arrow.Arrow>` object from a ``datetime`` and
        ...
        Usage::
            ...
            >>> aevum.Format.fromdatetime(dt)
            <Aevum [2021-04-07T13:48:00-07:00]>
    ...
    def fromdate(cls, date: date, tzinfo: Optional[TZ_EXPR] = None) -> "Arrow":
        """Constructs an :class:`Arrow <Aevum.arrow.Arrow>` object from a ``date`` and optional
    ...
    def strptime(
        ...
        """Constructs an :class:`Arrow <Aevum.arrow.Arrow>` object from a date string and format,
        ...
        Usage::
            ...
            >>> aevum.Format.strptime('20-01-2019 15:49:10', '%d-%m-%Y %H:%M:%S')
            <Aevum [2019-01-20T15:49:10+00:00]>
    ...
    def fromordinal(cls, ordinal: int) -> "Arrow":
        """Constructs an :class:`Arrow <Aevum.arrow.Arrow>` object corresponding
        ...
        Usage::
            ...
            <Aevum [2020-11-12T00:00:00+00:00]>
    ...
    def range(
        ...
        """Returns an iterator of :class:`Arrow <Aevum.arrow.Arrow>` objects, representing
        ...
        **NOTE**: ``tz`` internally **replaces** the timezones of both ``start`` and ``end`` before
        ...
        Recognized datetime expressions:
            ...
            - An :class:`Arrow <Aevum.arrow.Arrow>` object.
            - A ``datetime`` object.
        ...
        Usage::
            ...
            >>> for r in aevum.Format.range('hour', start, end):
            ...     print(repr(r))
            ...
            <Aevum [2013-05-05T12:30:00+00:00]>
            <Aevum [2013-05-05T13:30:00+00:00]>
            <Aevum [2013-05-05T14:30:00+00:00]>
            <Aevum [2013-05-05T15:30:00+00:00]>
            <Aevum [2013-05-05T16:30:00+00:00]>
    ...
    def span(
        ...
        """Returns a tuple of two new :class:`Arrow <Aevum.arrow.Arrow>` objects, representing the timespan
        of the :class:`Arrow <Aevum.arrow.Arrow>` object in a given timeframe.
        ...
        Usage::
            ...
            >>> aevum.utc()
            <Aevum [2013-05-09T03:32:36.186203+00:00]>

            >>> aevum.utc().span('hour')
            (<Aevum [2013-05-09T03:00:00+00:00]>, <Aevum [2013-05-09T03:59:59.999999+00:00]>)

            >>> aevum.utc().span('day')
            (<Aevum [2013-05-09T00:00:00+00:00]>, <Aevum [2013-05-09T23:59:59.999999+00:00]>)

            >>> aevum.utc().span('day', count=2)
            (<Aevum [2013-05-09T00:00:00+00:00]>, <Aevum [2013-05-10T23:59:59.999999+00:00]>)

            >>> aevum.utc().span('day', bounds='[]')
            (<Aevum [2013-05-09T00:00:00+00:00]>, <Aevum [2013-05-10T00:00:00+00:00]>)

            >>> aevum.utc().span('week')
            (<Aevum [2021-02-22T00:00:00+00:00]>, <Aevum [2021-02-28T23:59:59.999999+00:00]>)

            >>> aevum.utc().span('week', week_start=6)
            (<Aevum [2021-02-20T00:00:00+00:00]>, <Aevum [2021-02-26T23:59:59.999999+00:00]>)
    ...
    def floor(self, frame: _T_FRAMES) -> "Arrow":
        """Returns a new :class:`Arrow <Aevum.arrow.Arrow>` object, representing the "floor"
        of the timespan of the :class:`Arrow <Aevum.arrow.Arrow>` object in a given timeframe.
        Equivalent to the first element in the 2-tuple returned by
        :func:`span <Aevum.arrow.Arrow.span>`.

        :param frame: the timeframe.  Can be any ``datetime`` property (day, hour, minute...).

        Usage::

            >>> aevum.utc().floor('hour')
            <Aevum [2013-05-09T03:00:00+00:00]>
    ...
    def ceil(self, frame: _T_FRAMES) -> "Arrow":
        """Returns a new :class:`Arrow <Aevum.arrow.Arrow>` object, representing the "ceiling"
        of the timespan of the :class:`Arrow <Aevum.arrow.Arrow>` object in a given timeframe.
        ...
        Usage::
            ...
            >>> aevum.utc().ceil('hour')
            <Aevum [2013-05-09T03:59:59.999999+00:00]>
    ...
    def span_range(
        ...
        """Returns an iterator of tuples, each :class:`Arrow <Aevum.arrow.Arrow>` objects,
        ...
        **NOTE**: Unlike Python's ``range``, ``end`` will *always* be included in the returned
        ...
        Usage:
            ...
            >>> start = datetime(2013, 5, 5, 12, 30)
            >>> end = datetime(2013, 5, 5, 17, 15)
            >>> for r in aevum.Format.span_range('hour', start, end):
            ...     print(r)
            ...
            (<Aevum [2013-05-05T12:00:00+00:00]>, <Aevum [2013-05-05T12:59:59.999999+00:00]>)
            (<Aevum [2013-05-05T13:00:00+00:00]>, <Aevum [2013-05-05T13:59:59.999999+00:00]>)
            (<Aevum [2013-05-05T14:00:00+00:00]>, <Aevum [2013-05-05T14:59:59.999999+00:00]>)
            (<Aevum [2013-05-05T15:00:00+00:00]>, <Aevum [2013-05-05T15:59:59.999999+00:00]>)
            (<Aevum [2013-05-05T16:00:00+00:00]>, <Aevum [2013-05-05T16:59:59.999999+00:00]>)
            (<Aevum [2013-05-05T17:00:00+00:00]>, <Aevum [2013-05-05T17:59:59.999999+00:00]>)
    ...
    def interval(
        ...
        Usage:
            ...
            >>> start = datetime(2013, 5, 5, 12, 30)
            >>> end = datetime(2013, 5, 5, 17, 15)
            >>> for r in aevum.Format.interval('hour', start, end, 2):
            ...     print r
            ...
            (<Aevum [2013-05-05T12:00:00+00:00]>, <Aevum [2013-05-05T13:59:59.999999+00:00]>)
            (<Aevum [2013-05-05T14:00:00+00:00]>, <Aevum [2013-05-05T15:59:59.999999+00:00]>)
            (<Aevum [2013-05-05T16:00:00+00:00]>, <Aevum [2013-05-05T17:59:59.999999+00:0]>)
        """
        if interval < 1:
    ...
    def tzinfo(self) -> dt_tzinfo:
        """Gets the ``tzinfo`` of the :class:`Arrow <Aevum.arrow.Arrow>` object.
    ...
    def datetime(self) -> dt_datetime:
        """Returns a datetime representation of the :class:`Arrow <Aevum.arrow.Arrow>` object.
    ...
    def naive(self) -> dt_datetime:
        """Returns a naive datetime representation of the :class:`Arrow <Aevum.arrow.Arrow>`
        object.

        Usage::

            >>> nairobi = aevum.time('Africa/Nairobi')
            >>> nairobi
            <Aevum [2019-01-23T19:27:12.297999+03:00]>
            >>> nairobi.naive
    ...
    def timestamp(self) -> float:
        """Returns a timestamp representation of the :class:`Arrow <Aevum.arrow.Arrow>` object, in
        UTC time.
    ...
    def int_timestamp(self) -> int:
        """Returns an integer timestamp representation of the :class:`Arrow <Aevum.arrow.Arrow>` object, in
        UTC time.

        Usage::

            >>> aevum.utc().int_timestamp
            1548260567
    ...
    def float_timestamp(self) -> float:
        """Returns a floating-point timestamp representation of the :class:`Arrow <Aevum.arrow.Arrow>`
        object, in UTC time.

        Usage::

            >>> aevum.utc().float_timestamp
            1548260516.830896
    ...
    @property
    def fold(self) -> int:
        """Returns the ``fold`` value of the :class:`Arrow <Aevum.arrow.Arrow>` object."""

        return self._datetime.fold

    @property
    def ambiguous(self) -> bool:
        """Indicates whether the :class:`Arrow <Aevum.arrow.Arrow>` object is a repeated wall time in the current
        timezone.
    ...
    def imaginary(self) -> bool:
        """Indicates whether the :class: `Arrow <Aevum.arrow.Arrow>` object exists in the current timezone."""
    ...
    def clone(self) -> "Arrow":
        """Returns a new :class:`Arrow <Aevum.arrow.Arrow>` object, cloned from the current one.
    ...
    def replace(self, **kwargs: Any) -> "Arrow":
        """Returns a new :class:`Arrow <Aevum.arrow.Arrow>` object with attributes updated
        according to inputs.
        ...
        Use property names to set their value absolutely::
            ...
            >>> arw = aevum.utc()
            >>> arw
            <Aevum [2013-05-11T22:27:34.787885+00:00]>
            >>> arw.replace(year=2014, month=6)
            <Aevum [2014-06-11T22:27:34.787885+00:00]>

        You can also replace the timezone without conversion, using a
        :ref:`timezone expression <tz-expr>`::

            >>> arw.replace(tzinfo=tz.tzlocal())
            <Aevum [2013-05-11T22:27:34.787885-07:00]>
    ...
    def shift(self, **kwargs: Any) -> "Arrow":
        ...
        <Aevum [2014-04-11T22:27:34.787885+00:00]>
        ...
        >>> arw.shift(weekday=0)
        <Aevum [2013-05-13T22:27:34.787885+00:00]>
    ...
    def to(self, tz: TZ_EXPR) -> "Arrow":
        """Returns a new :class:`Arrow <Aevum.arrow.Arrow>` object, converted
        ...
        Usage::
            ...
            >>> utc = aevum.utc()
            >>> utc
            <Aevum [2013-05-09T03:49:12.311072+00:00]>

            >>> utc.to('US/Pacific')
            <Aevum [2013-05-08T20:49:12.311072-07:00]>
    ...
    def format(
        ...
        """Returns a string representation of the :class:`Arrow <Aevum.arrow.Arrow>` object,
        ...
        Usage::
            ...
            >>> aevum.utc().format('YYYY-MM-DD HH:mm:ss ZZ')
            '2013-05-09 03:56:47 -00:00'

            >>> aevum.utc().format('X')
            '1368071882'

            >>> aevum.utc().format('MMMM DD, YYYY')
            'May 09, 2013'
    ...
    def humanize(
        ...
        :param other: (optional) an :class:`Arrow <Aevum.arrow.Arrow>` or ``datetime`` object.
            Defaults to now in the current :class:`Arrow <Aevum.arrow.Arrow>` object's timezone.
        ...
        Usage::
            ...
            >>> earlier = aevum.utc().shift(hours=-2)
            >>> earlier.humanize()
            '2 hours ago'
        ...
        if other is None:
            utc = dt_datetime.utc().replace(tzinfo=dateutil_tz.tzutc())
    ...
    def dehumanize(self, timestring: str, locale: str = "en_us") -> "Arrow":
        """Returns a new :class:`Arrow <Aevum.arrow.Arrow>` object, that represents
        the time difference relative to the attrbiutes of the
        :class:`Arrow <Aevum.arrow.Arrow>` object.
        ...
        Usage::
                ...
                >>> arw = aevum.utc()
                >>> arw
                <Aevum [2021-04-20T22:27:34.787885+00:00]>
                >>> earlier = arw.dehumanize("2 days ago")
                >>> earlier
                <Aevum [2021-04-18T22:27:34.787885+00:00]>
                ...
                >>> later
                <Aevum [2021-05-18T22:27:34.787885+00:00]>
    ...
    def is_between(
        ...
        """Returns a boolean denoting whether the :class:`Arrow <Aevum.arrow.Arrow>` object is between
        the start and end limits.

        :param start: an :class:`Arrow <Aevum.arrow.Arrow>` object.
        :param end: an :class:`Arrow <Aevum.arrow.Arrow>` object.
        :param bounds: (optional) a ``str`` of either '()', '(]', '[)', or '[]' that specifies
        ...
        Usage::
            ...
            >>> start = aevum.get(datetime(2013, 5, 5, 12, 30, 10))
            >>> end = aevum.get(datetime(2013, 5, 5, 12, 30, 36))
            >>> aevum.get(datetime(2013, 5, 5, 12, 30, 27)).is_between(start, end)
            True

            >>> start = aevum.get(datetime(2013, 5, 5))
            >>> end = aevum.get(datetime(2013, 5, 8))
            >>> aevum.get(datetime(2013, 5, 8)).is_between(start, end, '[]')
            True
    ...
    def astimezone(self, tz: Optional[dt_tzinfo]) -> dt_datetime:
        ...
        Usage::
            ...
            >>> pacific=aevum.time('US/Pacific')
            >>> nyc=aevum.time('America/New_York').tzinfo
    ...
    def utcoffset(self) -> Optional[timedelta]:
        ...
        Usage::
            ...
            >>> aevum.time('US/Pacific').utcoffset()
    ...
    def strftime(self, format: str) -> str:
        ...
        Usage::
            ...
            >>> aevum.utc().strftime('%d-%m-%Y %H:%M:%S')
            '23-01-2019 12:28:17'
